...
makeinstall_target() {
  ...
  find $ROOT/$PKG_BUILD/ -name cfg80211.ko -exec cp {} $INSTALL/usr/lib/modules/$(get_module_dir)/$PKG_NAME/cfg80211_qca.ko \;
  find $ROOT/$PKG_BUILD/ -name compat.ko -exec cp {} $INSTALL/usr/lib/modules/$(get_module_dir)/$PKG_NAME \;
  find $ROOT/$PKG_BUILD/ -name wlan.ko -exec cp {} $INSTALL/usr/lib/modules/$(get_module_dir)/$PKG_NAME \;
}
